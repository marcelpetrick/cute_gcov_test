...
############################################################################################################
# You should edit the following three paths if necessary.
############################################################################################################
...
SRC_DIR="$SCRIPT_DIR/../../build-cute_gcov-Desktop_Qt_5_12_5_GCC_64bit-Debug/"
...
lcov -r "${COV_DIR}/coverage.info" "*Qt*.framework*" "*.h" "*/tests/*" "*Xcode.app*" "*.moc" "*moc_*.cpp" "*/test/*" "*/build*/*" "*/c++/*" -o "${COV_DIR}/coverage-filtered.info"
